"""CLI interface for git history mining.
...
from git_history_proof_engineering_eval import run_mining

app = typer.Typer(
    help="Git history proof repair mining tools",
...
def generate(
    ...
    """Generate proof repair challenges from git history.
